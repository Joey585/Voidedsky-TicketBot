...
function createTicket(interaction){
    ...
    interaction.guild.channels.create({
        ...
        channel.setTopic("ticket ID: " + id).then(() => {
            const newTicket = { id: id, creatorID: interaction.user.id.toString(), type: type, timeCreated: Math.round(Date.now() / 1000), lastTalked: null, participants: {}, closed: false, reason: "", closeUserId: ""}
